        ...
        var a = function() {
          ...
          , s = function() {
            ...
            t.on("click", function() {
                ...
                $(this).data("flag") ? (i($(this)),
                $(this).data("flag", !1)) : (a($(this)),
                $(this).data("flag", !0))
            }),
            ...
            for (var i = 0, t = a.length; i < t; i++) {
                ...
                var o = s.template_type
                  ...
                  , d = function(a) {
                    ...
                    var r = c - a * o;
                    for (r; r < o; r++)
                        i += '<div class="pos product_' + o + "_" + r + '" style="background:' + s.color + '"><div class="full"><p class="icon"></p><h2>敬请期待</h2><h3></h3></div></div>';
                    return i
                }
                ;
                if (r > 1)
                    ...
                    $('<div class="product-pic"></div>').html(d()).appendTo(l);
                l.appendTo($("#scroll"))
            }
          ...
          , c = function() {
            var a, i = $("#scroll div.cur-type").children("div.product-pic").length, t = "";
            for (a = 0; a < i; a++)
                t += "<span></span>";
            ...
            var a = $("#upbtn")
              ...
              , p = function() {
                ...
                $("#select").on("click", "li", function() {
                    ...
                    0 == $(this).index() ? a.fadeOut() : ($("#nobuy").children().removeClass(),
                    a.fadeIn())
                }),
